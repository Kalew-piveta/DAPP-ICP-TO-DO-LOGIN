...
function tarefas() {
  ...
  const [total_concluidas, setTotal_Concl] = useState([]);
...
async function totalTarefasConcluidas() {
    const total_concluidas = await to_do_backend.totalTarefasConcluidas();
    setTotal_Concl(parseInt(total_concluidas));
}
  ...
  return (
    ...
    <main class="mt-[30px] mx-[30px]">
        ...
        <div class="mt-4 flex justify-end">
            <div class="w-[30%] p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <label class="block text-red-500 font-bold mb-2">TOTAL</label>
                <div class="p-2 border border-gray-300 rounded bg-gray-50 text-red-500 font-bold text-center dark:bg-gray-700 dark:border-gray-600">
                    {total} {/* Exibe o valor do total */}
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 flex justify-end">
            ...
            <label class="block text-red-500 font-bold mb-2">TOTAL</label>
                <div class="p-2 border border-gray-300 rounded bg-gray-50 text-red-500 font-bold text-center dark:bg-gray-700 dark:border-gray-600">
                    {total_concluidas} {/* Exibe o valor do total */}
                </div>
            </div>
        </div>
